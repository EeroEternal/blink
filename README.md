...
Deployers should use the published artifacts:
...
The image binds `0.0.0.0:8787` by default. No crates.io patch, local BoxLite checkout, or libkrun build is required on the deploy host; point XEnsemble at `BLINK_API_URL=http://127.0.0.1:8787`.
